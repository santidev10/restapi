...
class StaticPermissions:
    ...
    BUILD__CTL = "ctl"
    BUILD__CTL_CREATE = "build__ctl_create"
    BUILD__CTL_DELETE = "build__ctl_delete"
    BUILD__CTL_FEATURE_LIST = "build__ctl_feature_list"
    BUILD__CTL_EXPORT_BASIC = "build__ctl_export_basic"
    BUILD__CTL_EXPORT_ADMIN = "build__ctl_export_admin"
    BUILD__CTL_SEE_ALL = "build__ctl_see_all"
    BUILD__CTL_VET = "build__ctl_vet"
    BUILD__CTL_VET_ADMIN = "build__ctl_vet_admin"
    BUILD__CTL_VET_EXPORT = "build__ctl_vet_export"
