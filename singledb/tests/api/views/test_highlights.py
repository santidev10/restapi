...
class HighlightKeywordsListApiViewTestCase(ExtendedAPITestCase):
    ...
    def test_list_requests_category_views_from_sdb(self, requests_mock):
        ...
        self.assertIn("category_daily_views", fields)
        self.assertIn("category_weekly_views", fields)
        self.assertIn("category_thirty_days_views", fields)
        self.assertIn("category_total_views", fields)
