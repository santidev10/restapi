...
class KeywordsList(BaseModel):
    ...
    top_keywords = models.TextField(null=True, default="")
    cum_average_volume = models.TextField(null=True, default="")
    cum_average_volume_per_kw = models.TextField(null=True, default="")
