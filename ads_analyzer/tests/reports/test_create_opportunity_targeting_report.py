...
class CreateOpportunityTargetingReportDevicesDataTestCase(CreateOpportunityTargetingReportTargetTestCase):
    SHEET_NAME = "Devices"
    ...
    def test_cost_delivery_percentage(self):
        ...
        stats_1 = AdGroupStatistic.objects.create(ad_group=self.ad_group, device_id=1, date=any_date, average_position=1,
                                                cost=costs[0])
        stats_2 = AdGroupStatistic.objects.create(ad_group=self.ad_group, device_id=2, date=any_date, average_position=1,
                                                cost=costs[1])
