...
class CreateAccountTargetingReportTargetDataTestCase(TransactionTestCase):
    ...
    def test_age_range(self):
        ...
        criteria = CriteriaType.objects.create(id=CriteriaTypeEnum.AGE_RANGE.value, name=CriteriaTypeEnum.AGE_RANGE.name)
        ...
        stat_1 = AgeRangeStatistic.objects.create(ad_group=ag_18_24, age_range_id=AgeRange.AGE_18_24, date=date.today(),
                                                  impressions=55, video_views=43, cost=3.1, clicks=4)
        stat_2 = AgeRangeStatistic.objects.create(ad_group=ag_18_24, age_range_id=AgeRange.AGE_18_24, date=date.today() + timedelta(days=1),
                                                  impressions=34, video_views=12, cost=5.82, clicks=12)

        stat_3 = AgeRangeStatistic.objects.create(ad_group=ag_25_34, age_range_id=AgeRange.AGE_25_34, date=date.today(),
                                                  impressions=13, video_views=11, cost=1.8, clicks=3)
        stat_4 = AgeRangeStatistic.objects.create(ad_group=ag_25_34, age_range_id=AgeRange.AGE_25_34, date=date.today() + timedelta(days=1),
    ...
    def test_parents(self):
        ...
        stat_2 = ParentStatistic.objects.create(ad_group=ag_parent, parent_status_id=Parent.PARENT, date=date.today() + timedelta(days=1),
                                                impressions=54, video_views=5, cost=4.6, clicks=5)

        stat_3 = ParentStatistic.objects.create(ad_group=ag_not_parent, parent_status_id=Parent.NOT_A_PARENT, date=date.today(),
    ...
    def test_gender(self):
        ...
        stat_2 = GenderStatistic.objects.create(ad_group=ag_male, gender_id=Gender.MALE, date=date.today() + timedelta(days=1),
                                                impressions=54, video_views=5, cost=4.6, clicks=5)
    ...
    def test_keyword(self):
        ...
        stat_2 = KeywordStatistic.objects.create(ad_group=ag_1, keyword=keyword_1, date=date.today() + timedelta(days=1),
    ...
    def test_audience(self):
        ...
        op, pl = self._create_salesforce(pl_params)
        campaign = Campaign.objects.create(account=account, salesforce_placement=pl, impressions=10082, video_views=776)
        ...
        stat_1 = AudienceStatistic.objects.create(ad_group=ag_1, audience_id=audience_1.id, date=date.today(),
                                                  impressions=643, video_views=123, cost=11.7, clicks=5)
        stat_2 = AudienceStatistic.objects.create(ad_group=ag_1, audience_id=audience_1.id, date=date.today() + timedelta(days=1),
                                                  impressions=559, video_views=73, cost=10.8, clicks=11)
        ...
        stat_6 = RemarkStatistic.objects.create(ad_group=ag_remarketing, remark_id=audience_remarketing.id,
                                                ...
                                                cost=0.98, clicks=5)
        report = AccountTargetingReport(account, criterion_types=[CriteriaTypeEnum.USER_INTEREST.name, CriteriaTypeEnum.USER_LIST.name])
        report.prepare_report(aggregation_columns=AGGREGATIONS)
    ...
    def test_placement(self):
        ...
        op, pl = self._create_salesforce(pl_params)
        campaign = Campaign.objects.create(account=account, salesforce_placement=pl, impressions=9290, video_views=1943)
        ...
        criteria = CriteriaType.objects.create(id=CriteriaTypeEnum.PLACEMENT.value, name=CriteriaTypeEnum.PLACEMENT.name)
        ...
        stat_3 = YTVideoStatistic.objects.create(ad_group=ag_video, yt_id=yt_video_id, date=date.today(),
                                                 impressions=220, video_views=75, cost=10.4, clicks=0)
        stat_4 = YTVideoStatistic.objects.create(ad_group=ag_video, yt_id=yt_video_id, date=date.today() + timedelta(days=1),
                                                 impressions=332, video_views=101, cost=12.8, clicks=0)
    ...
    def test_percentage_annotation_100_max(self):
        ...
        op, pl = self._create_salesforce(pl_params)
        campaign = Campaign.objects.create(account=account, salesforce_placement=pl, impressions=100, video_views=100, cost=100)
        ad_group = AdGroup.objects.create(name="topics", campaign=campaign)
        topic, _ = Topic.objects.get_or_create(name=f"Test topic {next(int_iterator)}")
        criteria = CriteriaType.objects.create(id=CriteriaTypeEnum.VERTICAL.value, name=CriteriaTypeEnum.VERTICAL.name)
