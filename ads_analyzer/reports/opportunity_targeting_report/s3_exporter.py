...
S3_FILE_KEY_PATTERN = "opportunity_targeting_reports/{opportunity_id}_{date_from}_{date_to}_{created_at}.xlsx"
DATETIME_REPORT_FORMAT = "%Y%m%d%H%M%S"
...
class OpportunityTargetingReportS3Exporter(S3Exporter):
    ...
    def get_s3_key(report):
        key = S3_FILE_KEY_PATTERN.format(opportunity_id=report.opportunity_id,
                                         ...
                                         created_at=report.created_at.strftime(DATETIME_REPORT_FORMAT))
        return key
