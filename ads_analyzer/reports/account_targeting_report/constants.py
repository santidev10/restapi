...
class TargetingStatisticsConfigs:
    ...
    SHARED_SUMMARY_AGGREGATIONS = (SUM_IMPRESSIONS, SUM_VIDEO_VIEWS, SUM_CLICKS, AVERAGE_COST, AVERAGE_REVENUE)

    class All:
        AGGREGATIONS = (COST_SHARE, IMPRESSIONS_SHARE, VIDEO_VIEWS_SHARE, VIDEO_VIEW_RATE, CONTRACTED_RATE, AVERAGE_CPV,
                        AVERAGE_CPM, PROFIT, MARGIN, CTR_I, CTR_V)
        SUMMARY_COLUMNS = (SUM_IMPRESSIONS, SUM_VIDEO_VIEWS, AVERAGE_VIEW_RATE, AVERAGE_CONTRACTED_RATE, AVERAGE_CPM,
                           AVERAGE_CPV, SUM_COST, SUM_REVENUE, SUM_PROFIT, SUM_MARGIN, SUM_CLICKS, AVERAGE_CTR_I,
                           AVERAGE_CTR_V)
