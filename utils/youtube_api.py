...
class YoutubeAPIConnector(object):
    ...
    def __init__(self, developer_key=settings.YOUTUBE_API_DEVELOPER_KEY, service_name="youtube",
                 api_version="v3", access_token=None, refresh_token=None, token_expiry=0, max_retries=None):
        """
        ...
        self.max_connect_retries = max_retries if max_retries is not None else 5
