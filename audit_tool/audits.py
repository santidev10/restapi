...
class ChannelAudit(Audit):
    ...
    def calculate_brand_safety_score(self, score_mapping):
        ...
        for audit in self.video_audits:
            channel_category_scores["categories"] += Counter(audit[constants.BRAND_SAFETY_SCORE["categories"]])
            channel_category_scores["overall_score"] += audit[constants.BRAND_SAFETY_SCORE["overall_score"]
