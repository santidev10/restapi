# Generated by Django 2.2.4 on 2020-02-11 22:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(choices=[(0, 'MC / Brand'), (1, 'Regular UGC'), (2, 'Premium UGC')],
        ...
        migrations.CreateModel(
            name='AuditGender',
            fields=[
                ('id', models.IntegerField(choices=[(0, 'Neutral'), (1, 'Female'), (2, 'Male')], primary_key=True,
                                           serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(
                    choices=[(0, '0 - 3 Toddlers'), (1, '4 - 8 Young Kids'), (2, '9 - 12 Older Kids'),
                             (3, '13 - 17 Teens'), (4, '18 - 35 Adults'), (5, '36 - 54 Older Adults'),
                             (6, '55+ Seniors'), (7, 'Group - Kids (not teens)'), (8, 'Group - Family Friendly')],
                    primary_key=True, serialize=False)),
                ...
                ('parent', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE,
                                             related_name='children', to='audit_tool.AuditAgeGroup')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE,
                                              related_name='channel_vets', to='audit_tool.AuditChannel')),
            ],
            options={
