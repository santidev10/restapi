...
class AuditSaveAPITestCase(ExtendedAPITestCase):
    ...
    def test_reject_audit_view_permission(self):
        """ Users must have audit_queue.create permission audit_queue.read is insufficient """
        self.user = self.create_test_user(perms={StaticPermissions.AUDIT_QUEUE__READ: True})
    ...
    def test_reject_vetting_enable_permissions(self):
        self.user = self.create_test_user(perms={StaticPermissions.AUDIT_QUEUE__CREATE: False})
