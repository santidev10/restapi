...
urlpatterns = [
    ...
    url(r'^channels/authentication/$', ChannelAuthenticationApiView.as_view(), name='channel_authentication'),
    ...
    url(r'^channels/video_by_keyword/', ChannelsVideosByKeywords.as_view(), name='channel_keyword_videos'),
]
