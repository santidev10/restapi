...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            with PidFile("upsert_taskus_channels_data.pid", piddir="."):
                init_es_connection()
                ...
                with open(os.path.join(settings.BASE_DIR, file_name), "r") as f:
                    ...
                    for row in reader:
                        ...
                        try:
                            ...
                            is_user_generated_content = content_type == "UGC"
                        ...
                        try:
                            is_monetizable = row[7].lower().strip() == "monetized"
                            if is_monetizable:
                        ...
                        try:
                            ...
                            if scalable:
                                current_channel_taskus_data["scalable"] = scalable == "Scalable"
                        # pylint: disable=broad-except
                        except Exception:
                            # pylint: enable=broad-except
                            pass
                            ...
                            if len(all_channel_ids) >= 10000:
                                ...
                                for channel in all_channels:
                                    ...
                                    if chan_id in channels_monetization_dict:
                                        ...
                                        try:
                                            audit_channel = AuditChannel.get_or_create(chan_id,
                                                                                       create=False).auditchannelmeta
            ...
            raise PidFileError
    # pylint: enable=too-many-locals,too-many-nested-blocks,too-many-branches,too-many-statements
