...
class Opportunity(models.Model, DemoEntityModelMixin):
    ...
    def get_data(cls, data):
        ...
        res = dict(
            ...
            disney_campaign_advertiser_id=data.get(Fields.DISNEY_CAMPAIGN_ADVERTISER_ID, None),
        )
        if sales_email:
...
class OpPlacement(BaseModel, DemoEntityModelMixin):
    ...
    def get_data(cls, data):
        ...
        res = dict(
            ...
            disney_datorama_placement_name=data.get(Fields.DISNEY_DATORAMA_PLACEMENT_NAME, None),
        )
        return res
