...
from aw_reporting.tasks_old import get_ad_groups_and_stats
from aw_reporting.tasks_old import get_campaigns
from aw_reporting.tasks_old import load_hourly_stats
