    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("manager",
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name="customers",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("manager", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                              related_name="connections", to="aw_reporting.Account")),
                ("user",
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="account_connections",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("status", models.CharField(max_length=7, null=True)),
                ("account", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="campaigns",
                                              to="aw_reporting.Account")),
            ],
            options={
                "abstract": False,
