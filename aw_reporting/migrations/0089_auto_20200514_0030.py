...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.IntegerField(
                    choices=[(0, "Keyword"), (1, "Placement"), (2, "Vertical"), (3, "User List"), (4, "User Interest"),
                             (5, "Age Range"), (6, "Gender"), (7, "Parental status"), (8, "Youtube Channel"),
                             (9, "Youtube Video")], primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            ...
            name="ad_group",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="targeting",
