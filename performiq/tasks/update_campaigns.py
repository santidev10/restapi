...
def update_campaigns_task(oauth_account_id):
    oauth_account = OAuthAccount.objects.get(id=oauth_account_id).refresh_token
    gads_accounts = get_customers(oauth_account.refresh_token)
    mcc_accounts = []
    cid_accounts = []
